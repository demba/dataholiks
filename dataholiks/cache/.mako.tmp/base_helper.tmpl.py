...
_magic_number = 10
_modified_time = 1452800156.399866
_enable_loop = True
...
def render_late_load_js(context):
    ...
    try:
        ...
        if use_bundles:
            ...
            __M_writer('        <script src="/assets/js/mathjax.js"></script>\n        <script src="/assets/js/jquery.colorbox-min.js"></script>\n')
